...
__all__ = [
    'ISpeechVoiceStatus', 'ISpeechLexicon',
    'DISPID_SRCEventInterests', 'DISPID_SRGReset',
    'DISPID_SPIElements', '_SPAUDIOSTATE',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRRTStreamTime',
    'SRSInactive', 'DISPID_SMSADeviceId', 'SRADefaultToActive',
    'SECFEmulateResult', 'ISpeechPhraseElements',
    'SAFT44kHz16BitMono', 'SPPS_RESERVED1', 'DISPID_SGRsAdd',
    'SAFT16kHz16BitMono', 'SPWT_LEXICAL', 'SAFT22kHz16BitStereo',
    'SDTReplacement', 'SpInprocRecognizer', 'SPVOICESTATUS',
    'SGSEnabled', 'IStream', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_PRIVATE9', 'SPBO_PAUSE', 'ISpRecognizer3',
    'SPLEXICONTYPE', 'ISpeechXMLRecoResult', 'ISpRecoGrammar',
    'DISPID_SPISaveToMemory', 'SVPAlert', '_ISpeechVoiceEvents',
    'DISPID_SPRsCount', 'DISPID_SpeechRecognizerStatus', 'SLTApp',
    'DISPID_SPANumberOfElementsInResult', 'SINone', 'SREAdaptation',
    'ISpeechRecoContext', 'SPPS_RESERVED2', 'SGSDisabled',
    'DISPID_SRDisplayUI', 'DISPID_SPEActualConfidence',
    'SVSFParseSsml', 'SECLowConfidence', 'DISPID_SRSClsidEngine',
    'SVP_6', 'DISPID_SRCEPropertyNumberChange', 'ISpRecoResult',
    'SpeechGrammarTagDictation', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCERecognizerStateChange', 'ISpEventSource',
    'DISPID_SDKOpenKey', 'DISPID_SpeechPhraseElement',
    'DISPID_SPCLangId', 'DISPID_SRCPause', 'SpWaveFormatEx',
    'SPEI_MIN_SR', 'DISPIDSPTSI', 'DISPIDSPRG', 'ISpeechRecoResult2',
    'DISPID_SPIEngineId', 'SP_VISEME_12', 'SPSNotOverriden',
    'SPSNoun', 'SVP_8', 'SINoSignal', 'DISPID_SpeechAudio',
    'DISPID_SRGetPropertyNumber', 'SSFMOpenForRead', 'SPINTERFERENCE',
    'SP_VISEME_16', 'DISPID_SABIMinNotification', 'SAFT32kHz8BitMono',
    'SPCS_DISABLED', 'SPRST_INACTIVE', 'DISPID_SpeechRecognizer',
    'SASClosed', 'DISPID_SRCERequestUI', 'SAFTADPCM_8kHzMono',
    'SPWAVEFORMATTYPE', 'DISPID_SPRuleConfidence', 'SPSSuppressWord',
    'ISequentialStream', 'DISPID_SLPsItem', 'SRAImport',
    'SPXRO_Alternates_SML', 'SREHypothesis', 'ISpGrammarBuilder',
    'ISpeechRecognizerStatus', 'eLEXTYPE_PRIVATE12', 'SGRSTTRule',
    'DISPID_SPAs_NewEnum', 'SPDKL_DefaultLocation',
    'DISPID_SMSSetData', 'SpMMAudioIn', 'SDKLLocalMachine',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEAdaptation',
    'SPAR_Medium', 'SPBOOKMARKOPTIONS', 'SPRULESTATE',
    'ISpeechRecognizer', 'ISpRecognizer', 'DISPID_SVSLastResult',
    'DISPID_SRRPhraseInfo', 'ISpObjectWithToken', 'SDKLCurrentUser',
    'SVP_2', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechGrammarRuleStateTransitions', 'SRTExtendableParse',
    'SpeechVisemeFeature', 'ISpeechBaseStream', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVResume', 'DISPID_SFSOpen', 'SSTTDictation',
    ...
    'DISPID_SpeechVoiceEvent', 'SpeechDiscardType', 'SPAS_CLOSED',
    'SPEI_PHONEME', 'SPEI_INTERFERENCE', 'DISPID_SRState',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRRecognizer',
    'ISpeechObjectTokenCategory', 'SpeechDataKeyLocation',
    'SPAO_RETAIN_AUDIO', 'SpeechGrammarTagWildcard', 'SPGS_DISABLED',
    'DISPID_SWFEChannels', 'SINoise', 'IInternetSecurityManager',
    'SP_VISEME_15', 'DISPID_SAFSetWaveFormatEx',
    'SpObjectTokenCategory', 'SPRECOSTATE', 'SPVPRI_ALERT',
    'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVSFVoiceMask',
    'DISPID_SRGRecoContext', 'SREStateChange', 'SPXMLRESULTOPTIONS',
    'SREAllEvents', 'SPSERIALIZEDPHRASE', 'SPGRAMMARSTATE',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_RESERVED5',
    'DISPID_SRCEBookmark', 'SAFT44kHz8BitStereo', 'ISpPhoneConverter',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPIGetText', 'SAFT44kHz16BitStereo',
    'ISpRecognizer2', 'SpeechGrammarRuleStateTransitionType',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPRules_NewEnum',
    'SPEI_HYPOTHESIS', 'SPPHRASEELEMENT', 'SSTTTextBuffer',
    'SVSFIsXML', 'SpeechUserTraining', 'SpeechBookmarkOptions',
    'DISPID_SADefaultFormat', 'SPFILEMODE', 'SPFM_NUM_MODES',
    'eLEXTYPE_PRIVATE11', 'STSF_AppData', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRRAlternates', 'SITooFast', 'SVEAudioLevel',
    ...
    'SpTextSelectionInformation', 'SAFTGSM610_22kHzMono', 'SVP_3',
    'SPSEMANTICERRORINFO', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPSInterjection',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPLOADOPTIONS',
    'SPDKL_CurrentConfig', 'SVP_14', 'DISPID_SVSPhonemeId',
    'SPAR_Unknown', 'SPAS_STOP', 'SRATopLevel', 'SVSFNLPMask',
    'DISPID_SVVoice', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SABufferInfo',
    'SFTInput', 'SpeechVisemeType', 'DISPID_SPIEnginePrivateData',
    'SRERecognition', 'eLEXTYPE_PRIVATE17', 'SAFT44kHz8BitMono',
    'DISPID_SPEsCount', 'DISPID_SPPValue',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechTokenKeyFiles',
    'ISpeechResourceLoader', 'DISPID_SRRTLength',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVEStreamEnd',
    'DISPID_SGRSAddRuleTransition', 'SP_VISEME_6', 'DISPID_SLWLangId',
    ...
    'SRERequestUI', 'DISPID_SpeechPhoneConverter', 'SPEI_ADAPTATION',
    'SAFT16kHz8BitMono', 'SSTTWildcard', 'SPBO_TIME_UNITS',
    'SWTAdded', 'SAFT32kHz8BitStereo', 'SITooSlow', 'SVEBookmark',
    'SAFT24kHz8BitStereo', 'SpSharedRecoContext', 'SPEI_TTS_BOOKMARK',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SVSInputWordPosition', 'SVP_0', 'DISPID_SWFEExtraData',
    'DISPID_SVGetVoices', 'DISPID_SRAudioInputStream', 'SPSFunction',
    'DISPID_SPPFirstElement', 'DISPID_SPRuleId', 'SPEI_VISEME',
    'SPGS_EXCLUSIVE', 'ISpeechObjectToken',
    'DISPID_SRGIsPronounceable', 'SpResourceManager', 'SPWORD',
    'SAFT48kHz8BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVSLastBookmark',
    'SPEI_RESERVED6', 'SGDisplay', 'ISpeechPhraseElement',
    'ISpStreamFormat', 'SpeechWordType', 'DISPID_SLWs_NewEnum',
    'SPWT_PRONUNCIATION', 'DISPID_SPRuleChildren',
    'SAFT48kHz8BitMono', 'SpShortcut', 'SpeechAddRemoveWord',
    'SpSharedRecognizer', 'SPAR_High', 'DISPID_SVEStreamStart',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechGrammarRule',
    'DISPID_SRGCommit', 'SpCompressedLexicon', 'ISpeechAudio',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPCT_SUB_DICTATION',
    'STCInprocHandler', 'DISPID_SVEAudioLevel', 'SLODynamic',
    'SpStream', 'DISPID_SGRInitialState', 'SRERecoOtherContext',
    'SITooQuiet', 'DISPID_SVEBookmark', 'DISPID_SLGetPronunciations',
    'SpeechGrammarState', 'DISPID_SRCEAudioLevel', 'SPPS_Noun',
    'DISPID_SRCResume', 'SAFT12kHz16BitMono', 'SPRECOCONTEXTSTATUS',
    ...
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpAudio', 'SPBO_NONE',
    'DISPID_SASState', 'eLEXTYPE_RESERVED7',
    'DISPID_SLWPronunciations', 'DISPID_SOTsItem', 'SVSFParseMask',
    'DISPID_SOTCreateInstance', 'DISPID_SDKSetBinaryValue',
    'SpeechCategoryPhoneConverters', 'DISPID_SPEAudioSizeTime',
    'SpeechDictationTopicSpelling', 'DISPID_SPEEngineConfidence',
    'DISPID_SPARecoResult', 'DISPID_SGRAddResource', 'ISpRecoContext',
    'DISPID_SLPSymbolic', 'ISpXMLRecoResult', 'DISPID_SPPParent',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPEsItem', 'SVP_18',
    'SRAONone', 'DISPID_SPCPhoneToId', 'DISPID_SRCBookmark',
    'SPEI_SR_RETAINEDAUDIO', 'SVP_21', 'DISPID_SVEEnginePrivate',
    'SPWF_SRENGINE', 'SPEI_RECO_OTHER_CONTEXT', 'SPWF_INPUT',
    'SPSModifier', 'SPGS_ENABLED', 'eLEXTYPE_RESERVED6',
    'SRSEIsSpeaking', 'DISPID_SFSClose',
    'DISPID_SPEDisplayAttributes', 'SPEI_SOUND_END',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPRFirstElement',
    'SpeechRetainedAudioOptions', 'SPEI_END_SR_STREAM', 'SLOStatic',
    'DISPID_SpeechMMSysAudio', 'DISPID_SGRsItem',
    'SPFM_CREATE_ALWAYS', 'SAFTNoAssignedFormat', 'DISPID_SLPLangId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SP_VISEME_0',
    'DISPID_SRCState', 'DISPID_SRIsUISupported',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPIGetDisplayAttributes',
    'SPCT_COMMAND', 'DISPID_SpeechMemoryStream', 'SAFT8kHz16BitMono',
    'SRSActiveAlways', 'SPEI_FALSE_RECOGNITION', 'DISPID_SAVolume',
    'DISPID_SRIsShared', 'DISPID_SVIsUISupported',
    'DISPID_SpeechPhraseProperty', 'SPSMF_UPS', 'SPAS_PAUSE',
    'SpeechVoiceSpeakFlags', 'SPEI_SR_PRIVATE', 'SPEVENTSOURCEINFO',
    'SAFTCCITT_ALaw_11kHzStereo', 'SP_VISEME_14', 'SVP_11',
    'SPVPRIORITY', 'SPFM_OPEN_READONLY',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVGetAudioOutputs', 'SVSFIsNotXML', 'SAFT48kHz16BitMono',
    'DISPID_SRCEEnginePrivate', 'SRTAutopause', 'DISPID_SGRName',
    'SpeechRecognitionType', 'DISPID_SVPause',
    'DISPID_SpeechWaveFormatEx', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechPartOfSpeech', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechVoiceStatus', 'SWPKnownWordPronounceable',
    'DISPID_SPRDisplayAttributes', 'ISpStreamFormatConverter',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SOTDataKey',
    'ISpeechPhraseRule', 'SpNotifyTranslator', 'DISPID_SGRSTsItem',
    'SSSPTRelativeToEnd', 'DISPID_SPIGrammarId', 'SPEI_RESERVED2',
    'ISpObjectTokenCategory', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SOTCGetDataKey', 'SPAR_Low',
    ...
    'eLEXTYPE_PRIVATE5', 'DISPID_SRGDictationUnload', 'SAFTDefault',
    'DISPID_SABIEventBias', 'DISPID_SpeechObjectTokens',
    'SPVPRI_OVER', 'DISPID_SRGetRecognizers', 'SAFT24kHz8BitMono',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechLexiconPronunciation',
    'DISPID_SLGetWords', 'DISPID_SRRAudioFormat',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_LETTERTOSOUND',
    'SVSFParseSapi', 'DISPID_SPRText', 'SpeechRuleAttributes',
    'SpeechVoiceCategoryTTSRate', 'ISpeechPhoneConverter',
    'SDTDisplayText', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPIStartTime', 'DISPID_SVAudioOutput', 'ISpPhrase',
    'eLEXTYPE_PRIVATE8', 'SPRECORESULTTIMES', 'DISPID_SBSSeek',
    'STSF_CommonAppData', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFT22kHz8BitMono', 'SGRSTTTextBuffer', 'SGDSInactive',
    'SGDSActiveWithAutoPause', 'SVSFPurgeBeforeSpeak', 'SPEI_MAX_TTS',
    'DISPID_SASNonBlockingIO', 'SECFNoSpecialChars',
    'DISPID_SBSFormat', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechPhraseInfo', 'ISpeechMemoryStream',
    'eLEXTYPE_PRIVATE14', 'SpMMAudioOut',
    'DISPID_SPERequiredConfidence', 'DISPID_SGRsDynamic',
    'ISpProperties', 'SPRST_ACTIVE', 'DISPID_SPIProperties',
    'DISPID_SpeechFileStream', 'SRSActive', 'SPFM_CREATE',
    'SWPUnknownWordPronounceable', 'DISPID_SOTs_NewEnum',
    'SVSFlagsAsync', 'SVP_17', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_REQUEST_UI', 'SAFT24kHz16BitMono', 'SFTSREngine', 'SVP_4',
    'DISPID_SOTCId', 'SAFTADPCM_44kHzMono', 'SP_VISEME_8', 'SASPause',
    ...
    'ISpVoice', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SLWsCount', 'SPLO_DYNAMIC', 'SVEPrivate',
    'SAFT48kHz16BitStereo', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVSInputSentenceLength', 'SpObjectToken',
    'DISPID_SRSAudioStatus', 'DISPID_SPAsItem', 'SRAInterpreter',
    'STCInprocServer', 'SAFT11kHz8BitStereo', 'SPCT_DICTATION',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechObjectToken',
    'DISPID_SPRuleParent', 'SSFMOpenReadWrite', 'SVP_12',
    'SRTStandard', 'eLEXTYPE_PRIVATE4', 'ISpeechGrammarRuleState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SGSExclusive',
    'DISPID_SRGState', 'SPSEMANTICFORMAT', 'SP_VISEME_9',
    'eLEXTYPE_PRIVATE7', 'SpeechVoiceSkipTypeSentence',
    'SpeechGrammarWordType', 'SpeechRegistryUserRoot',
    'SPEI_START_INPUT_STREAM', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCEStartStream', 'SDTProperty',
    'SAFT8kHz8BitMono', 'SLTUser', 'DISPID_SRCVoice',
    'SPPHRASEPROPERTY', 'DISPID_SpeechLexiconWords',
    'eLEXTYPE_PRIVATE10', 'DISPID_SVWaitUntilDone', 'STCRemoteServer',
    'SpLexicon', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPIDSPTSI_SelectionOffset',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechRecoResultTimes',
    'DISPID_SASetState', 'DISPID_SRRGetXMLResult', 'SP_VISEME_21',
    ...
    'SPSERIALIZEDRESULT', 'SPRST_NUM_STATES', 'ISpeechWaveFormatEx',
    ...
    'SpPhraseInfoBuilder', 'DISPID_SRCESoundEnd',
    'SAFT16kHz16BitStereo', 'SPVISEMES', 'SpeechAudioFormatGUIDText',
    'SpeechTokenKeyUI', 'DISPID_SVESentenceBoundary', 'SPAUDIOSTATE',
    'ISpeechRecoResultDispatch', 'SpeechTokenValueCLSID',
    'SDA_One_Trailing_Space', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPEs_NewEnum', 'SPCATEGORYTYPE',
    'DISPID_SPPEngineConfidence', 'DISPIDSPTSI_SelectionLength',
    'SPAUDIOSTATUS', 'SP_VISEME_7', 'DISPID_SLWsItem',
    'DISPID_SOTCategory', 'DISPID_SVEventInterests',
    'SpUnCompressedLexicon', 'ISpLexicon', 'SAFT8kHz16BitStereo',
    'DISPID_SGRId', 'SPCS_ENABLED', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPRsItem', 'eLEXTYPE_PRIVATE15', 'SPPS_SuppressWord',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SDKSetLongValue',
    'SPINTERFERENCE_NONE', 'DISPID_SVEVoiceChange', 'SVSFPersistXML',
    'SPDATAKEYLOCATION', 'DISPID_SRCRequestedUIType', 'SRTEmulated',
    'SPPARTOFSPEECH', 'SPLO_STATIC', 'SECFIgnoreCase',
    'DISPID_SpeechLexiconWord', 'SAFT32kHz16BitStereo',
    'DISPID_SVSVisemeId', 'ISpPhraseAlt', 'SPWT_DISPLAY', 'SPSVerb',
    'SPRULE', 'ISpeechRecoGrammar',
    'DISPID_SRCAudioInInterferenceStatus', 'SDTAlternates',
    'SGRSTTWildcard', 'DISPID_SOTSetId', 'DISPID_SOTGetAttribute',
    'STCAll', 'SP_VISEME_20', 'ISpeechPhraseAlternates',
    'DISPID_SMSGetData', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLWType', 'SPSLMA', 'DISPID_SVEWord', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRCERecognition', 'SPWORDLIST',
    'ISpPhoneticAlphabetSelection', 'SVP_20', 'tagSTATSTG',
    'DISPID_SVSpeakStream', 'DISPID_SpeechRecoResultTimes',
    'SPSMF_SAPI_PROPERTIES', 'SPPS_Unknown', 'SVP_19',
    'DISPID_SBSWrite', 'SECFIgnoreWidth', 'DISPID_SRGId',
    'DISPID_SRRAudio', 'DISPID_SGRAddState', 'DISPID_SGRsCount',
    'DISPID_SpeechPhraseBuilder', 'ISpeechDataKey',
    'eLEXTYPE_RESERVED10', 'DISPID_SpeechRecoResult', 'SDTAll',
    'SPDKL_LocalMachine', 'DISPID_SLWWord', 'DISPID_SVEViseme',
    'SAFTCCITT_uLaw_22kHzMono', 'SREFalseRecognition', 'SpFileStream',
    'SpeechCategoryRecognizers', 'DISPID_SRRTTickCount',
    'DISPID_SDKEnumKeys', 'SVSFIsFilename', 'Speech_StreamPos_Asap',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechMMSysAudio',
    'SVSFNLPSpeakPunc', 'SpeechPropertyComplexResponseSpeed',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_RESERVED8',
    'SPRST_INACTIVE_WITH_PURGE', 'SRARoot', 'DISPID_SPIRule',
    'SREStreamStart', 'DISPID_SRProfile', 'ISpeechPhraseProperties',
    'SPPS_Modifier', 'SAFTCCITT_uLaw_22kHzStereo',
    'ISpeechLexiconWord', 'ISpeechGrammarRule',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_PRIVATE20',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SDKDeleteValue', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRSTText', 'SECFDefault',
    'SPSHT_EMAIL', 'SpPhoneConverter', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SRESoundStart',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPPId', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRAudioInput', 'SVF_Stressed', 'ISpRecoGrammar2',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechAudioFormat',
    'SAFTADPCM_22kHzMono', 'DISPID_SRGetFormat',
    'DISPID_SRCVoicePurgeEvent', 'SREStreamEnd', 'DISPID_SpeechVoice',
    'DISPID_SPPChildren', 'SpeechLexiconType', 'DISPID_SPPName',
    'ISpNotifySink', 'SpeechInterference', 'SP_VISEME_2',
    'ISpeechPhraseInfo', 'DISPID_SRSetPropertyString',
    'SREPhraseStart', 'DISPID_SMSALineId', 'SAFT24kHz16BitStereo',
    'SAFT32kHz16BitMono', 'DISPID_SGRSAddSpecialTransition',
    'SPPS_NotOverriden', 'LONG_PTR', 'SDTPronunciation',
    'DISPID_SGRSTs_NewEnum', 'SVP_13', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SLPPhoneIds', 'SPSHT_Unknown', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTCCITT_uLaw_8kHzMono', 'SPPHRASERULE', 'ISpeechAudioFormat',
    'SPAS_RUN', 'SDA_Consume_Leading_Spaces', 'SPAO_NONE', 'SpVoice',
    'eLEXTYPE_USER', 'DISPID_SABIBufferSize',
    'ISpeechPhraseReplacement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SGRSTsCount',
    'SPEI_UNDEFINED', 'SVEStartInputStream', 'DISPID_SGRAttributes',
    'SAFTADPCM_11kHzMono', 'ISpeechRecoResult', 'SPRS_INACTIVE',
    'SPGRAMMARWORDTYPE', 'DISPID_SOTMatchesAttributes',
    'SpeechMicTraining', 'DISPID_SDKGetBinaryValue',
    'ISpResourceManager', 'SGRSTTWord', 'SPSHORTCUTTYPE',
    ...
    'SVP_15', 'SAFT22kHz16BitMono', 'ISpeechObjectTokens',
    'ISpeechAudioStatus', 'SpeechAudioVolume', 'SRAExport',
    'DISPID_SOTDisplayUI', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechGrammarRules', 'SPAUDIOBUFFERINFO',
    'DISPID_SRRGetXMLErrorInfo', 'SVEViseme', 'SPEI_RECOGNITION',
    'DISPID_SPACommit', 'DISPID_SPPsCount', 'SPPS_RESERVED3',
    'SAFT11kHz16BitMono', 'DISPID_SGRs_NewEnum', 'STCLocalServer',
    'SP_VISEME_18', 'SpAudioFormat', 'SREAudioLevel',
    'DISPID_SPRulesCount', 'SpeechStreamFileMode', 'SDTLexicalForm',
    'DISPID_SVGetProfiles', 'ISpeechPhraseAlternate', 'ISpMMSysAudio',
    'DISPID_SAStatus', 'DISPID_SLPPartOfSpeech',
    'SpeechCategoryAudioOut', 'DISPID_SVSLastBookmarkId',
    'SPEI_SOUND_START', 'SPPS_LMA', 'SPPHRASEREPLACEMENT',
    ...
    'DISPID_SGRSTRule', 'SVP_5', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVSInputWordLength', 'DISPID_SVEPhoneme',
    'DISPID_SRCSetAdaptationData', 'IEnumString', 'DISPID_SAFType',
    'SAFTText', 'DISPID_SPPs_NewEnum', 'DISPID_SLGenerationId',
    'SDTAudio', 'DISPID_SRCreateRecoContext',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCEInterference',
    'eLEXTYPE_PRIVATE3', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SDKEnumValues', 'DISPID_SRRRecoContext', 'SP_VISEME_17',
    'SVPNormal', 'DISPID_SRCRetainedAudioFormat', 'SpeechAllElements',
    'DISPID_SPIAudioStreamPosition', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT22kHz8BitStereo', 'DISPID_SRRTOffsetFromStart', 'SGDSActive',
    'SECHighConfidence', 'SDA_No_Trailing_Space', 'ISpStream',
    'DISPID_SRGSetWordSequenceData', 'SpeechDisplayAttributes',
    'DISPID_SDKSetStringValue', 'ISpDataKey', 'DISPID_SOTCDefault',
    'SP_VISEME_19', 'SREPropertyStringChange', 'SVF_None',
    'DISPID_SGRSAddWordTransition', 'DISPID_SLGetGenerationChange',
    'SRESoundEnd', 'SPCT_SLEEP', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVRate', 'DISPID_SRSSupportedLanguages',
    'SREInterference', 'ISpeechLexiconWords',
    'DISPID_SOTIsUISupported', 'SPPS_Verb', 'SpeechRunState',
    'SpeechLoadOption', 'ISpeechAudioBufferInfo',
    'SAFTGSM610_44kHzMono', 'SAFTCCITT_ALaw_11kHzMono',
    'SVSFUnusedFlags', 'SPRECOGNIZERSTATUS', 'SP_VISEME_11',
    'SRTReSent', 'SSFMCreate', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVAlertBoundary', 'SPEI_WORD_BOUNDARY',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPEDisplayText',
    'tagSPPROPERTYINFO', 'DISPID_SPAStartElementInResult',
    'SpeechRecoContextState', '_RemotableHandle', 'SPXRO_SML',
    'DISPID_SOTRemove', 'DISPID_SAFGuid', 'SRCS_Enabled',
    'DISPID_SRCCreateGrammar', 'SASRun', 'DISPID_SPAsCount',
    'SPVPRI_NORMAL', 'SpeechPropertyResponseSpeed', 'SDTRule',
    'DISPID_SVSpeak', 'SPPHRASE', 'SPAUDIOOPTIONS',
    'SVEEndInputStream', 'SSSPTRelativeToStart', 'SPSHT_OTHER',
    'DISPID_SPEPronunciation', 'SpInProcRecoContext',
    'DISPID_SRCESoundStart', 'DISPID_SPELexicalForm',
    'SAFTExtendedAudioFormat', 'DISPID_SGRSTransitions',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechLexiconPronunciation',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_START_SR_STREAM',
    'DISPID_SDKDeleteKey', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SLPsCount', 'SASStop', 'SPEI_SR_BOOKMARK',
    'DISPID_SRCRecognizer', 'SPEI_SENTENCE_BOUNDARY',
    'SDKLCurrentConfig', 'DISPID_SpeechRecoResult2',
    'SpeechEngineConfidence', 'SVP_10', 'Speech_Max_Word_Length',
    'DISPID_SRGetPropertyString', 'SpNullPhoneConverter',
    'DISPID_SRGDictationLoad', 'SGPronounciation',
    'DISPID_SpeechDataKey', 'SPEI_RESERVED1', 'DISPID_SPILanguageId',
    'SPEVENTENUM', 'DISPID_SRSCurrentStreamNumber', 'ISpRecoContext2',
    'Speech_StreamPos_RealTime', 'SBOPause', 'UINT_PTR',
    'SP_VISEME_13', 'ISpeechPhraseProperty', 'SPPS_Function',
    'SpeechCategoryRecoProfiles', 'ISpObjectToken',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPRuleFirstElement', 'Speech_Max_Pron_Length',
    'DISPID_SAEventHandle', 'DISPID_SWFEBlockAlign',
    'SpeechTokenContext', 'SPPROPERTYINFO',
    'DISPID_SpeechPhraseRules', 'ISpRecoCategory',
    'IInternetSecurityMgrSite', 'SpeechRecognizerState',
    'DISPID_SVSRunningState', 'SAFT16kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'DISPID_SLPType', 'DISPID_SGRClear',
    'SPEI_MIN_TTS', 'SpPhoneticAlphabetConverter',
    'SAFTADPCM_11kHzStereo', 'ISpeechPhraseReplacements',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRGCmdLoadFromResource', 'SAFT12kHz16BitStereo',
    'DISPID_SGRSTType', 'SpeechFormatType',
    'ISpeechTextSelectionInformation', 'ISpeechPhraseInfoBuilder',
    'SWTDeleted', 'DISPID_SPRNumberOfElements', 'SpCustomStream',
    'SpeechTokenIdUserLexicon', 'SVEAllEvents', 'DISPID_SGRSRule',
    '_ISpeechRecoContextEvents', 'SAFTGSM610_11kHzMono',
    'DISPID_SPIReplacements', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SREmulateRecognition', 'SAFTGSM610_8kHzMono',
    'DISPID_SPRulesItem', 'DISPID_SRCEHypothesis',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechCategoryVoices',
    'eLEXTYPE_PRIVATE13', 'SRAORetainAudio', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechRecoContext', 'SAFT11kHz16BitStereo', 'SVP_1',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRRSpeakAudio', 'DISPID_SVSkip',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPBO_AHEAD',
    'ISpeechLexiconPronunciations',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SWFEFormatTag',
    'DISPID_SGRSTNextState', 'SpeechVoiceEvents', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVVolume', 'ISpEventSink',
    'eLEXTYPE_PRIVATE18', 'SSFMCreateForWrite', 'DISPID_SPCIdToPhone',
    'DISPID_SGRsCommit', 'SREBookmark',
    'DISPID_SpeechPhraseProperties', 'tagSPTEXTSELECTIONINFO',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SOTCSetId',
    'DISPID_SpeechPhraseReplacement', 'SVSFParseAutodetect',
    'SBONone', 'DISPID_SOTId', 'SP_VISEME_3', 'ISpShortcut',
    'SGRSTTDictation', 'DISPID_SRRSetTextFeedback',
    'SpStreamFormatConverter', 'SpeechStreamSeekPositionType',
    'DISPID_SRGRules', 'ISpeechFileStream', 'SP_VISEME_4',
    ...
    'eWORDTYPE_DELETED', 'SPEI_MAX_SR', 'SpMemoryStream',
    'SRSInactiveWithPurge', 'SGLexical', 'SPWORDTYPE',
    'STSF_LocalAppData', 'SPCONTEXTSTATE', 'ISpNotifyTranslator',
    'DISPID_SPEAudioStreamOffset', 'SVP_9', 'SVSFDefault',
    'SVEWordBoundary', 'eLEXTYPE_APP', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SCSBaseStream', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechCustomStream', 'Speech_Default_Weight', 'SVEPhoneme',
    'SpeechAudioProperties', 'SVP_7', 'DISPID_SpeechPhraseElements',
    'DISPID_SRSNumberOfActiveRules', 'SPPS_Interjection', 'SVPOver',
    ...
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechBaseStream', 'SPPS_RESERVED4',
    'SPBINARYGRAMMAR', 'SAFT11kHz8BitMono', 'DISPID_SRStatus',
    'SPPS_Noncontent', 'DISPID_SRCEEndStream',
    'SpeechAudioFormatType', 'SRADynamic', 'ISpNotifySource',
    'SRCS_Disabled', 'ISpSerializeState', 'SITooLoud',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRRTimes',
    'SDA_Two_Trailing_Spaces', 'SpeechSpecialTransitionType',
    'SPWORDPRONOUNCEABLE', 'SP_VISEME_1', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SVPriority', 'IEnumSpObjectTokens',
    'DISPID_SGRSTPropertyId', '__MIDL_IWinTypes_0009',
    'DISPID_SPRs_NewEnum', 'SPRS_ACTIVE', 'DISPID_SLAddPronunciation',
    'SPEVENT', 'SVESentenceBoundary', 'DISPID_SWFEBitsPerSample',
    'SPSUnknown', 'SPSHT_NotOverriden', 'SAFT12kHz8BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPEI_PHRASE_START', 'ISpeechVoice', 'SVP_16',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSHORTCUTPAIR',
    'DISPID_SPPsItem', 'DISPID_SDKCreateKey', 'SpeechAudioState',
    'SP_VISEME_10', 'SpeechRuleState', 'DISPID_SpeechLexiconProns',
    'SPEI_VOICE_CHANGE', 'STSF_FlagCreate', 'SPINTERFERENCE_TOOFAST',
    'SRSEDone', 'SPWORDPRONUNCIATION', 'SVEVoiceChange',
